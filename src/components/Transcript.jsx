...
export default function Transcript({
  ...
  const {
    ...
    timeslice: 30000, // fire roughly every 6 seconds to feel near-immediate
  });
  ...
  return (
    <div className="column h-full flex flex-col relative">
      <div className="column-header shrink-0">
        <div className="flex items-center gap-2">🎙️ Transcript</div>
          ...
          {transcripts.length === 0 ? (
                ...
                <div className="flex flex-col items-center gap-3">
                  ...
                  <p className="text-slate-600 dark:text-slate-300">
                    ...
                    <span className="text-sm opacity-70">
                      Chunks transcribe every 30 seconds.
                    </span>
                  </p>
                </div>
              ) : (
            ...
            <>
              {transcripts.map((entry) => (
                <div
                  key={entry.id}
                  className="group flex gap-3 pb-2 border-b border-slate-100 dark:border-slate-800/50 last:border-0 hover:bg-slate-50 dark:hover:bg-slate-800/20 p-2 -mx-2 rounded-lg transition-colors"
                >
              ...
              {isRecording && isTranscribing && (
                <div className="flex items-center gap-3 p-2 -mx-2 opacity-60">
                  <div className="text-xs font-mono text-transparent pt-1 shrink-0">
                    00:00
                  </div>
